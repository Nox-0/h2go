...
<body>
	...
	<div id="white-box-holder">
		<div id="white-box">
			<img id="front-page-image" class="front-page-item" src="images/bottle-l.jpg" alt="Bottled water (large)" />
			<h1 id="image-header" class="front-page-item">LARGE BOTTLE OF WATER</h1>
			<a href="shop.php" id="shop-now-button" class="front-page-item"><strong>SHOP NOW &rarr;</strong></a>
		</div>
	</div>
</body>
</html>
